...
export default class TimeAndCost3 extends Component {
  ...
  async getData(time) {
    ...
    console.log('Time 3');
    console.log(time);
    console.log(`this.state.fromCCode ${this.state.fromCCode}`);
    console.log(`this.state.fromSCode ${this.state.fromSCode}`);
    console.log(`this.state.fromCity ${this.state.fromCity}`);
    console.log(`this.state.toCCode ${this.state.toCCode}`);
    console.log(`this.state.toSCode ${this.state.toSCode}`);
    console.log(`this.state.toCity ${this.state.toCity}`);
    console.log(`this.state.toPostalCode ${this.state.toPostalCode}`);
    console.log(`this.state.fromPostalCode ${this.state.fromPostalCode}`);
    console.log(`this.state.varWeight ${this.state.varWeight}`);
    console.log(`this.state.varWidth ${this.state.varWidth}`);
    console.log(`this.state.varHeight ${this.state.varHeight}`);
    console.log(`this.state.varLength ${this.state.varLength}`);
    console.log(data);
    this.setState({
      rateData: data,
      flag2: false,
