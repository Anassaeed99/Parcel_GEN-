...
export default class Dashboard extends Component {
  ...
  // Get the list of all Siri shortcuts associated with your app
  ...
  async ForegroundNotifyHandlar() {
    console.log('ForegroundNotifyHandlar');
  ...
  async BackgroundNotifyHandle(Ca, Cap, TNum) {
    console.log('BackgroundNotifyHandle');
    this.setState({
      loaderFlag: true,
      enteredTNumber: TNum,
      Carrier_Value: Ca,
  ...
  async Onclick_Search() {
    ...
    console.log(this.state.enteredTNumber);
    console.log(this.state.Carrier_Value);
    console.log(this.state.enteredCaption);
    var checkNet;
    ...
    if (checkNet == true) {
      ...
      if (this.state.enteredTNumber == '') {
        ...
        if (this.state.Carrier_Value == 'Select Carrier') {
          ...
          // );
          var Res = this.state.enteredTNumber;
          console.log(Res);
          if (Res[0].count == 1) {
            console.log('insde else if');
            ...
            if (a.ResponseStatus == 'Success') {
              ...
              for (let i = 0; i < a.PackageInfoList.length; i++) {
                console.log(
                  `a.PackageInfoList.length ${a.PackageInfoList.length}`,
                );
              ...
              for (let i = 0; i < a.TimeinTransitInfoList.length; i++) {
                console.log(
                  `a.TimeinTransitInfoList.length ${a.TimeinTransitInfoList.length}`,
                );
                call_DB.insertData_TimeinTransitInfoList(
  ...
  OnClick_CarrierField() {
    console.log('OnClick_CarrierField');
  ...
  getDateDifference(strDate) {
    ...
    console.log(String(strDate).split(' '));
    console.log(strSplitDate[0]);
    console.log(strSplitDate[1]);
    console.log(dateStr.slice(0, 4));
    console.log(dateStr.slice(4, 6));
    console.log(dateStr.slice(6, 8));
    console.log(timeStr?.slice(0, 2));
    console.log(timeStr?.slice(2, 4));
    console.log(timeStr?.slice(4, 6));
    console.log(new Date(month + '/' + date + '/' + Year));
      ...
      <>
        ...
        {this.state.showCameraFlag ? (
          ...
          <>
            ...
            {/* <NavBar detail={{home: true, nav: this.props.navigation}} /> */}
            {/*  */}
            {/* Screen Detail  */}
              ...
              <View style={styles.View3}>
                ...
                <View style={styles.View6}>
                  <TextInput
                    ...
                    onChangeText={Caption => this.searchSiriFunction(Caption)}
                    onClear={c => searchFilterFunction('')}
                  />
                </View>
              </View>
