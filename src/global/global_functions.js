...
let global_functions = {
  ...
  async getStoreLocatorData(a) {
    ...
    for (let i = 0; i < a.SerachResult.itemsField.length; i++) {
      ...
      console.log(",,,,,,,,,,,,")
      console.log(a.SerachResult.itemsField[i].geocodeField.latitudeField)
      console.log(a.SerachResult.itemsField[i].geocodeField.longitudeField)
      console.log("@@@@@@@@@@@@@@@@@@@@@@@@@")
      console.log(".*.*.*.*.*.*.*.*.*")
      console.log(a.SerachResult.itemsField.length)
      console.log(a.SerachResult.itemsField)
      console.log(".*.*.*.*.*.*.*.*.*")

      // Get Services
      var temp1 = [];
      for (let j = 0; j < a.SerachResult.itemsField[i].serviceOfferingListField?.length; j++) {
